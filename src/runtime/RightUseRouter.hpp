...
private:
    ...
    static bool upperRightUseDetour(
        void* owner,
        std::uintptr_t arg1,
        std::uintptr_t arg2,
        std::uintptr_t arg3
    ...
    std::unique_ptr<pl::memory::HookHandle> mUpperRightUseHook;
    ...
    void* mUpperRightUseOriginal{nullptr};
    ...
    std::uintptr_t mUpperRightUseTarget{0};
