...
status=0
for case_name in release_off release_main release_stale transaction_unscoped consume_native_off off_count_sync consume_food consume_container consume_last consume_stale consume_main setter_unscoped sword main_pass both_pass main_success main_terminal air_snapshot air_main_success bow_block_pass main_scope off_terminal air_main_pass missing_snapshot disabled; do
