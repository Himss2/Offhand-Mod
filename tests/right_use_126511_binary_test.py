...
def main():
    ...
    assert len(guards) == 15, 'review new/removed guards explicitly'
    ...
    print('PASS: 1.26.51.1 binary identity, 15 guards, upper dispatcher, semantic tags, WeaponItem no-op, Item/ComponentItem use ABI')
