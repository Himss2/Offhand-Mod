...
def main():
    ...
    assert len(guards) == 14, 'review new/removed guards explicitly'
    ...
    print('PASS: 1.26.51.1 binary identity, 14 guards, semantic priority ABI, WeaponItem no-op, Item/ComponentItem use ABI')
