...
def main() -> int:
    ...
    require(
        ...
        "gUpperMainClaimed",
        "gUpperOffClaimed",
        "RightClickOwner::Main",
        "RightClickOwner::Off",
        "gRightClickPlayer",
        "gRightClickMainBlockAttempted",
        "gRightClickMainAirAttempted",
        "gRightClickOffBlockAttempted",
        "gRightClickOffAirAttempted",
        "RightUseRouter::upperUseDetour(",
        "click owner=MAIN; late OFF callbacks suppressed",
        "click owner=OFF; late duplicate callbacks suppressed",
